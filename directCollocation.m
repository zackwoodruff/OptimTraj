...
P.options = Opt.nlpOpt;
 ...
 options = optimoptions('fmincon',...
     'Display',Opt.nlpOpt.Display,...
     'Algorithm',Opt.nlpOpt.Algorithm,...
     'MaxFunctionEvaluations',Opt.nlpOpt.MaxFunEvals,...
     'MaxIter',Opt.nlpOpt.MaxIter,...
     'ConstraintTolerance',Opt.nlpOpt.ConstraintTolerance,...
     'OptimalityTolerance',Opt.nlpOpt.OptimalityTolerance,...
     'StepTolerance',Opt.nlpOpt.StepTolerance...
     );
 P.options = options;
